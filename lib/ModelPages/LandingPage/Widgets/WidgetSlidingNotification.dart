              ...
              child: Obx(
                () => GestureDetector(
                  onTap: () {
                    ...
                    landingPageController.fetchAndOpenWebView(
                        landingPageController.carouselIndex.value);
                  },
                  child: Stack(
                    children: [
                      CarouselSlider(
                        ...
                        carouselController:
                            landingPageController.carouselController_notify,
